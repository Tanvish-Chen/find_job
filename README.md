...
首版数据来自**各公司官方校招页的人工核实采集**（2026-08-28），均为真实、可溯源的岗位，未做任何编造。当前覆盖 **7 家 AI 原生公司、46 个全职校招岗位**：
...
**以下公司已确认有 27 届校招通道、但暂无可收录岗位，建议定期浏览器打开复查**：
- 生数科技校招官网：`https://shengshu.jobs.feishu.cn/692892`（当前 0 个在招岗位）
- 第四范式 Moka 校招：`https://app.mokahr.com/campus_apply/4paradigm/5073`（页面暂时无法加载，需人工复查）
