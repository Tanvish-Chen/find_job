...
首版数据来自**各公司官方校招页的人工核实采集**（2026-08-28），均为真实、可溯源的岗位，未做任何编造。当前覆盖 **17 家公司、93 个全职校招岗位**：
...
**下一轮待补充**：百度（官方职位列表需登录，27 届校招已启动）、网易、B站 等；外企与研究机构组（英伟达、微软、上海人工智能实验室等）；以下建议定期浏览器打开复查：
- vivo 校招官网：`https://hr-campus.vivo.com/`（北森系统，当前显示 0 个在招岗位，批次空档，随时可能放出；官方公告投递截止 2026-09-15）
- 生数科技校招官网：`https://shengshu.jobs.feishu.cn/692892`（当前 0 岗）
- 第四范式 Moka 校招：`https://app.mokahr.com/campus_apply/4paradigm/5073`（页面暂时无法加载）
